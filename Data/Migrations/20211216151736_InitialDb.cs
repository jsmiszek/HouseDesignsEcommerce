    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HouseDesignId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectName = table.Column<string>(nullable: true),
                    UseableArea = table.Column<double>(nullable: false),
                    MinPlotDimensionWidth = table.Column<double>(nullable: false),
                    MinPlotDimensionLength = table.Column<double>(nullable: false),
                    RoofAngle = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseDesigns", x => x.HouseDesignId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageCategoryId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageCategoryName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "HouseDesignCategory",
                columns: table => new
                {
                    HouseDesignCategoryId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HouseDesignId = table.Column<int>(nullable: false),
                    CategoryId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseDesignCategory", x => x.HouseDesignCategoryId);
                    table.ForeignKey(
                        name: "FK_HouseDesignCategory_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HouseDesignCategory_HouseDesigns_HouseDesignId",
                        column: x => x.HouseDesignId,
                        principalTable: "HouseDesigns",
                        principalColumn: "HouseDesignId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_HouseDesigns_HouseDesignId",
                        column: x => x.HouseDesignId,
                        principalTable: "HouseDesigns",
                        principalColumn: "HouseDesignId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseDesignCategory_CategoryId",
                table: "HouseDesignCategory",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseDesignCategory_HouseDesignId",
                table: "HouseDesignCategory",
                column: "HouseDesignId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_HouseDesignId",
                table: "Images",
                column: "HouseDesignId");
